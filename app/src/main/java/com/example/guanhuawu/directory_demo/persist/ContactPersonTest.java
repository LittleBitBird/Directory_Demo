 ...
 */
@DatabaseTable(tableName = "Contact_Person_Test")
public class ContactPersonTest {
    ...
    public ContactPersonTest(Integer contactPersonId, String surName, String firstName, String companyName, String phoneNumber, String telephoneNumber, String email, String address, String remarks) {
